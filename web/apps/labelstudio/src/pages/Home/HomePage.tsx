...
export const HomePage: Page = () => {
  ...
  const actions = [
    { title: t("home.createProject"), icon: IconFolderAdd, type: "createProject" as const },
    { title: t("home.inviteMembers"), icon: IconUserAdd, type: "inviteMembers" as const },
  ];

  useUpdatePageTitle(t("navigation.home"));
      ...
      <div className="grid grid-cols-[minmax(0,1fr)_450px] gap-6">
        <section className="flex flex-col gap-6">
          ...
          >
            {isFetching ? (
              ...
              <div className="h-64 flex justify-center items-center">{t("home.loadProjectsFailed")}</div>
              ...
              <div className="flex flex-col justify-center items-center border border-primary-border-subtle bg-primary-emphasis-subtle rounded-lg h-64">
                ...
                <Typography size="small" className="text-neutral-content-subtler">
                  {t("home.firstProjectHint")}
                </Typography>
                <Button className="mt-4" onClick={() => setModalIsOpen(true)} aria-label={t("projects.createNew")}>
        ...
        <section className="flex flex-col gap-6">
          <div className="flex gap-2 items-center">
            <span className="text-neutral-content-subtle">{t("home.communityVersion")}</span>
          </div>
        </section>
      </div>
