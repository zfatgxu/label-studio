...
export const StorageForm = forwardRef(
  ({ onSubmit, target, project, rootClass: _rootClass, storage, storageTypes }, ref) => {
        ...
        >
          ...
          <div className="flex gap-tight">
            <Button
              ...
              aria-label={t("settings.storage.form.checkConnectionAria")}
            >
              {t("settings.storage.form.checkConnection")}
            </Button>
            <Button
              type="submit"
