        ...
        <Dropdown.Trigger
          ...
          content={
            <Menu size="compact" style={{ width: 110 }}>
              <Menu.Item onClick={() => onEditStorage(storageData)}>{t("common.edit")}</Menu.Item>
    ...
    >
      ...
      <div className={rootClass.elem("sync").toClassName()}>
        <div className="mt-base">
          ...
          {notSyncedYet && (
            <div className={rootClass.elem("sync-count").toClassName()}>{t("settings.storage.card.syncHint")}</div>
          )}
        </div>
      </div>
    </Card>
