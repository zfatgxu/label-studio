                  ...
                  return (
                    ...
                    >
                      <div className={cn("people-list").elem("field").mix("avatar").toClassName()}>
                        <CopyableTooltip title={t("organization.userIdTooltip", { id: user.id })} textForCopy={user.id}>
